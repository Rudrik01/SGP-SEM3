jQuery(document).ready(function (s) {
  ...
  function d(s) {
    ...
    if (s.parents(".cd-headline").hasClass("type")) {
      var i = s.parent(".cd-words-wrapper");
      ...
      var a = s.children("i").length >= e.children("i").length;
      r(s.find("i").eq(0), s, a, 50), o(e.find("i").eq(0), e, a, 50);
    } else
  ...
  function r(e, i, a, n) {
    if (
      ...
      e.is(":last-child") && s("html").hasClass("no-csstransitions"))
    ) {
      var l = c(i);
      h(i, l);
    }
